                ...
                <Grid container
                    ...
                    <Grid container item xs={12} direction="row" spacing={1}>
                        <Grid item xs={12} md={6} container justifyContent="start">
                            <button onClick={onForgotPassword} className={styles.linkButton}>Forgot password?</button>
                        </Grid>
                        <Grid item container xs={12} md={6} justifyContent={{ lg: 'end', md: 'end', sm: 'start', xs: 'start' }}>
                            <button onClick={onRegisterClicked} className={styles.linkButton}>Don't have an account? Sign Up</button>
                        </Grid>
                    </Grid>
